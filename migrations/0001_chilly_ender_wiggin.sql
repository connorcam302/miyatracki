...
/*
 ...
 Due to that we don't generate migration automatically and it has to be done manually
*/--> statement-breakpoint
ALTER TABLE `Games` DROP COLUMN `game_platform`;--> statement-breakpoint
ALTER TABLE `Games` DROP COLUMN `start_date`;--> statement-breakpoint
ALTER TABLE `Games` DROP COLUMN `end_date`;--> statement-breakpoint
ALTER TABLE `BossDeathsInRun` DROP COLUMN `killed_by_user`;